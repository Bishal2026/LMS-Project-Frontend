              ...
              <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between">
                ...
                {role === "ADMIN" && (
                  <button
                    ...
                    className=" btn btn-primary px-2 py-1 rounded-md font-semibold text-sm text-white"
                  >
                    Add new lecture
                  </button>
                )}
                    ...
                    <li className="space-y-2" key={lecture._id}>
                      ...
                      {role === "ADMIN" && (
                        <button
                          ...
                          className="btn btn-error px-2 py-1 rounded-md font-semibold text-sm text-white"
                        >
                          Delete lecture
                        </button>
                      )}
